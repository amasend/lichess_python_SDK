...
from lichess_client.utils.hrefs import (USERS_ACTIVITY_URL, USERS_GET_BY_IDS_URL, USERS_LIVE_STREAMERS_URL,
                                        USERS_MY_PUZZLE_ACTIVITY_URL, USERS_PLAYER_TOP_URL, USERS_PLAYER_URL,
                                        USERS_RATING_HISTORY_URL, USERS_STATUS_URL, USERS_TEAM_MEMBERS_URL,
...
class Users(AbstractUsers):
    ...
    async def get_real_time_users_status(self, users_ids: List[str]) -> 'Response':
        ...
        response = await self._client.request(method=RequestMethods.GET, url=USERS_STATUS_URL,
    ...
    async def get_users_by_id(self, users_ids: List[str]) -> 'Response':
        ...
        data = ','.join(users_ids)
        response = await self._client.request(method=RequestMethods.POST, url=USERS_GET_BY_IDS_URL,
