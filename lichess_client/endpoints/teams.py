...
from lichess_client.utils.hrefs import TEAMS_JOIN_URL, TEAMS_LEAVE_URL, TEAMS_KICK_USER_URL
...
class Teams(AbstractTeams):
    ...
    async def kick_a_user_from_your_team(self, team_id: str, user_id: str) -> 'Response':
        """
