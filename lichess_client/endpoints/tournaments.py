...
from lichess_client.utils.hrefs import (
    TOURNAMENTS_CURRENT, TOURNAMENTS_CREATE, TOURNAMENTS_EXPORT_GAMES, TOURNAMENTS_EXPORT_RESULTS,
...
class Tournaments(AbstractTournaments):
    ...
    async def create(self,
        ...
        if position is None:
            data['position'] = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
